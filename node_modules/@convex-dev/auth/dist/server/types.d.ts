...
import { AnyDataModel, GenericActionCtx, GenericDataModel, GenericMutationCtx, GenericQueryCtx } from "convex/server";
...
export type ConvexAuthConfig = {
    ...
    jwt?: {
         ...
         * ```
         */
        customClaims?: (ctx: GenericQueryCtx<AnyDataModel>, args: {
    ...
    callbacks?: {
         ...
         * ```
         */
        beforeSessionCreation?: (ctx: GenericMutationCtx<AnyDataModel>, args: {
            /**
